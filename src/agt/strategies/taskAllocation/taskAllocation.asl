...
// ESSA TA COM BUG, QUANDO PRECISA DE MAIS DE UMA TOOL igual, SÓ RETORNA UMA
...
<-
	...
	.print("Tasks: ",Tasks);
//	.print("Coalition: ",NewCoalition);
//	!algorithm::run_distributed_TA_algorithm(communication(coalition,NewCoalition),Tasks,0);
