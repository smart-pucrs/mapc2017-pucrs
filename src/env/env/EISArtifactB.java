...
public class EISArtifactB extends Artifact implements AgentListener {

	private Logger logger = Logger.getLogger(EISArtifactB.class.getName());
	...
	protected void init() throws IOException, InterruptedException {
			ei = new EnvironmentInterface("conf/eismassimconfigB.json");
	        try {
	            ei.start();
	...
	void register(String entity)  {
		try {
			...
			logger = Logger.getLogger(EISArtifactB.class.getName()+"_"+agent);
